...
$jenis_pelanggaran      =   $_POST['jenis_tatib'];
                                    ...
                                    <div class="well">
                                        <table>
                                            <tr>
                                                ...
                                                <td><input type="text" name="nis" value="<?php echo $nim; ?>" hidden></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><h4><?php echo $jenis_pelanggaran; ?></h4></td>
                                                <td><input type="text" name="jenis_tatib" value="<?php echo $jenis_pelanggaran; ?>" hidden></td>
                                            </tr>
                                            <tr>
                                                <td><h4 style="margin-right: 20px;">Tingkat Pelanggaran :</h4></td>
                                                <td><h4><?php echo $level_tingkat; ?></h4></td>
                                                <td><input type="text" name="jenis_tatib" value="<?php echo $level_tingkat; ?>" hidden></td>
                                            </tr>
                                            <tr>
                                                <td><h4 style="margin-right: 20px;">Tanggal Kejadian :</h4></td>
                                                <td><h4><?php echo $tanggal_kejadian; ?></h4></td>
                                                <td><input type="text" name="level_tingkat" value="<?php echo $tanggal_kejadian; ?>" hidden></td>
                                            </tr>
                                            <tr>
                                                <td><h4 style="margin-right: 20px;">Nama Pelapor :</h4></td>
                                                <td><h4><?php echo $pelapor; ?></h4></td>
                                                <td><input type="text" name="nama_pelapor" value="<?php echo $pelapor; ?>" hidden></td>
                                            </tr>
                                        </table>
                                    </div>
