...
$qry_nomor_pelanggaran = "SELECT * FROM data_pelanggaran ORDER BY id DESC";
        ...
        <div class="page-sidebar sidebar horizontal-bar">
            <div class="page-sidebar-inner">
                <ul class="menu accordion-menu">
                    ...
                    <li class="droplink active"><a href="status_laporan.php"><span class="menu-icon icon-grid"></span><p>Status</p><span class="arrow"></span></a>
                    </li>
                </ul>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-white">
                            <div class="panel-heading clearfix">
                                <h4 class="panel-title">Status Laporan </h4>
                            </div>
                            <div class="panel-body">
                             <div class="table-responsive">
                                <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                    <thead>
                                        <tr>
                                            <th style="text-align: center;" width="200px">Nomor Pelanggaran</th>
                                        ...
                                        while ($show    =   mysqli_fetch_array($exe_nomor_pelanggaran)){
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center;">
                                                    <?php  
                                                    if ( $show['status'] == 'Y' ){
                                                        echo "Sudah Ditindaklanjuti ("; echo $show['status2']; echo " )";
                                                    }else if ( $show['status'] == 'N' ){
                                                        echo "Belum Ditindaklanjuti";
                                                    }else if ( $show['status'] == 'P' ){
                                                        echo "Sedang Ditindaklanjuti ("; echo $show['status2']; echo " )";
                                                    }
                                                    ?>
                                                </td>
                                                <td style="text-align: center;">
