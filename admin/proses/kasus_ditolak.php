<?php
	...
	$qry_update	=	"UPDATE data_pelanggaran SET status='Y' WHERE no_pelanggaran='$no_pelanggaran'";
	$exe_update	=	mysqli_query($db, $qry_update);

	if($exe_update){
		$qry_input	=	"UPDATE data_pelanggaran SET waktu_konfirmasi = '$waktu', status2 = 'Kasus Ditolak' WHERE no_pelanggaran = '$no_pelanggaran'";
